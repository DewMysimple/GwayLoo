...
for (const viewport of viewports) {
  ...
  cases.push({ ...viewport, runtimeState, definitionContent, layerState, cursorState, cameraState, leavesState, leavesLifecycle, fullPaintLifecycle, uvMapping, layerDurations, groundLifecycle, cutoutLifecycle, renderResolution, sourceMaterialState, backgroundCompositeState, globalGroundState, fluidPassState, fluidStencilState, fluidActivityState, idleHoverState, scrollStep, scrollResponse, rippleScene, smallBrushSample, largeBrushSample, brushSample, brushSlowMotion, brushMotion, grassLifecycle, slowMotion, timings, titleClick, fullPaintVisible, fullPaintState, fullPaintRuntimeState, poemOpening, poemHiding, poemClosed, fullPaintSoftFailure, fullPaintFailure, finalSlot, restartY });
}
