...
| 时间 | 类型 | 目标 | 状态 | 主题 | 日志 |
| --- | --- | --- | --- | --- | --- |
| 2026-08-23 | feature | 继续清除正式运行链路中的旧架构、旧压缩产物依赖和不可维护边界，让 R3F 成为默认运行时。 | archived | r3f-default-runtime-asset-boundary-migration | [[日志/2026-08-23-R3F默认切换与资源边界迁移.md|2026-08-23｜R3F 默认切换与资源边界迁移]] |
